...
template<> FMODSTUDIO_API UScriptStruct* StaticStruct<FFMODAssetLookupRow>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Private_FMODAssetLookup_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Private_FMODAssetLookup_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Private_FMODAssetLookup_h_370166532(TEXT("/Script/FMODStudio"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Private_FMODAssetLookup_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Private_FMODAssetLookup_h_Statics::ScriptStructInfo),
		nullptr, 0);
