...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_CallbackHandler_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFMODPlatformSettings_Statics::NewProp_CallbackHandler_MetaData[] = {
		{ "Category", "Advanced" },
#if !UE_BUILD_SHIPPING
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UScriptStruct_FFMODPlatformSettings_Statics::NewProp_CallbackHandler = { "CallbackHandler", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FFMODPlatformSettings, CallbackHandler), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFMODPlatformSettings_Statics::NewProp_CallbackHandler_MetaData), Z_Construct_UScriptStruct_FFMODPlatformSettings_Statics::NewProp_CallbackHandler_MetaData) };
...
template<> FMODSTUDIO_API UScriptStruct* StaticStruct<FFMODProjectLocale>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UFMODSettings_Statics::NewProp_CallbackHandler_MetaData[] = {
		{ "Category", "Advanced" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "/**\n     * Callback handler implementing IFMODCallbackHandler for calling into system at specific points in the integration's lifecycle.\n     */" },
#endif
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UFMODSettings_Statics::NewProp_CallbackHandler = { "CallbackHandler", nullptr, (EPropertyFlags)0x0014000000004001, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFMODSettings, CallbackHandler), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFMODSettings_Statics::NewProp_CallbackHandler_MetaData), Z_Construct_UClass_UFMODSettings_Statics::NewProp_CallbackHandler_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UFMODSettings_Statics::NewProp_Platforms = { "Platforms", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UFMODSettings, Platforms), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UFMODSettings_Statics::NewProp_Platforms_MetaData), Z_Construct_UClass_UFMODSettings_Statics::NewProp_Platforms_MetaData) }; // 750485934 3724278045
	...
	struct Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ScriptStructInfo[] = {
		{ FFMODPlatformSettings::StaticStruct, Z_Construct_UScriptStruct_FFMODPlatformSettings_Statics::NewStructOps, TEXT("FMODPlatformSettings"), &Z_Registration_Info_UScriptStruct_FMODPlatformSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFMODPlatformSettings), 3724278045U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFMODSettings, UFMODSettings::StaticClass, TEXT("UFMODSettings"), &Z_Registration_Info_UClass_UFMODSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFMODSettings), 4269833573U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_2318286390(TEXT("/Script/FMODStudio"),
		Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_ferkz_Documents_Proyectos_SinfoniaBiotica_SinfoniaBiotica_Plugins_FMODStudio_Source_FMODStudio_Classes_FMODSettings_h_Statics::EnumInfo));
